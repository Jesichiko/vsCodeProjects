...
public class PuntuacionesVista extends JFrame implements ActionListener {
    ...
    public JPanel pnTitle, pnImages, pnPlayers, pnPts, pnExit;
    public JLabel lbTitle, lbPlayer1, lbPlayer2, lbPlayer3, lbPlayer4, lbPunt1, lbPunt2, lbPunt3, lbPunt4;
    public JButton btGold, btBronze, btSilver, btGray, btExit;
